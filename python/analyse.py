...
def analyseResults(trace_array, textin_array):
  ...
  bestguess = singleThreaded(HW, numtraces, numpoint, pt, trace_array)
  print(bestguess)
...
def singleThreaded( HW, numtraces, numpoint, pt, trace_array ):
    bestguess = [0] * 16
    for bnum in tqdm(range(0,16), desc='Attacking subkeys', leave=False, position=2):
        cpaoutput = [0] * 256
        maxcpa = [0] * 256
